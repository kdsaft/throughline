...
function createOverlayWindow() {
    ...
    overlayWindow.jQ.css({ top: magicLensWrapper.jQ.position().top, left: (magicLensWrapper.jQ.position().left + 2), width: magicLens.jQ.width(), height: magicLens.jQ.height()});
